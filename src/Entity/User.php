...
class User implements UserInterface
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\Credit", inversedBy="users")
     */
    private $userCredit;
     ...
     */
    public function getUserCredit(): Collection
    {
        return $this->userCredit;
    }

    public function addUserCredit(Credit $userCredit): self
    {
    ...
    public function removeUserCredit(Credit $userCredit): self
    {
        if ($this->userCredit->contains($userCredit)) {
