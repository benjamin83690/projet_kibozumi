 ...
 */
final class Version20200326145456 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE credit ADD credit_category_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE credit DROP credit_category_id');
    }
}
