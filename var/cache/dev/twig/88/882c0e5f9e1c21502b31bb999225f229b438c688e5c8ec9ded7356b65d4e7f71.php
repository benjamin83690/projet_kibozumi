...
class __TwigTemplate_eb568ca6a3f10d7a8e1a38613b7699b6a55d7c2a283f132672fb2b7945f73109 extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 6
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["form2"]) || array_key_exists("form2", $context) ? $context["form2"] : (function () { throw new RuntimeError('Variable "form2" does not exist.', 6, $this->source); })()), 'form_start');
        echo "
    ";
        // line 7
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock((isset($context["form2"]) || array_key_exists("form2", $context) ? $context["form2"] : (function () { throw new RuntimeError('Variable "form2" does not exist.', 7, $this->source); })()), 'widget');
        echo "
    <button class=\"btn\">";
        // line 8
...
";
        // line 9
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["form2"]) || array_key_exists("form2", $context) ? $context["form2"] : (function () { throw new RuntimeError('Variable "form2" does not exist.', 9, $this->source); })()), 'form_end');
        echo "
";
    ...
    {
        return array (  72 => 9,  68 => 8,  64 => 7,  60 => 6,  55 => 4,  51 => 3,  47 => 2,  43 => 1,);
    }
...
{{ form_start(form2) }}
    ...
    <button class=\"btn\">{{ button_label|default('Save') }}</button>
{{ form_end(form2) }}
", "category/_form.html.twig", "C:\\Users\\julie\\Documents\\GitHub\\projet_kibozumi\\templates\\category\\_form.html.twig");
    }
}
