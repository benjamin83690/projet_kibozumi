...
class __TwigTemplate_0e8dc963a880ed225803985e48b9e40c0b56553a3aad7c681189b15253534fe0 extends Template
{
    private $source;
    private $macros = [];
    ...
    <button class='btn btn-success' href=\"";
        ...
        echo "\">Créer un nouvel utilisateur</button>
";
    ...
    {
        return array (  175 => 49,  167 => 43,  158 => 39,  149 => 35,  145 => 34,  140 => 32,  136 => 31,  132 => 30,  128 => 29,  124 => 28,  120 => 27,  116 => 26,  113 => 25,  108 => 24,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<div class=\"container\">
        ...
        {% for user in users %}
            <tr>
                ...
                <td>
                    <button class='btn btn-info' href=\"{{ path('user_show', {'id': user.id}) }}\">show</button>
                    <button class='btn btn-warning' href=\"{{ path('user_edit', {'id': user.id}) }}\">edit</button>
                </td>
            </tr>
        {% else %}
            <tr>
    ...
    <button class='btn btn-success' href=\"{{ path('user_new') }}\">Créer un nouvel utilisateur</button>
{% endblock %}
", "user/index.html.twig", "C:\\Users\\julie\\Documents\\GitHub\\projet_kibozumi\\templates\\user\\index.html.twig");
    }
}
